...
```bash
git checkout option3-pdf-template
```
...
Cambios en main
=======
Cambios en option3-pdf-template
>>>>>>> option3-pdf-template
```
...
2️⃣ Merge de la rama que te gustó (ejemplo: `option3-pdf-template`):

```bash
git merge option3-pdf-template
```
...
```bash
git commit -m "Agregar opción 3 – plantilla PDF"
```
